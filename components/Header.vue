<template>
  <nav class="site-header sticky-top">
      <div class="container d-flex flex-column flex-md-row justify-content-between">
        ...
        <a class="py-3 d-none d-md-inline-block" href="#">Fine商城</a>
        ...
        <nuxt-link class="p-3 mb-0 d-none d-md-inline-block bg-danger font-weight-bold h5" to="/order">直接預約</nuxt-link>
      </div>
    </nav>
</template>
